...
from model_diagnostics import check_learning_curve, show_confusion_matrix
...
def comparison(dataset, hidden_layers):
    ...
    #
    ir_features = dataset.drop(columns='Species').drop(columns='Species_0').drop(
        columns='Species_1').drop(columns='Species_2')
    ...
    for layers in hidden_layers:
        ...
        # show_confusion_matrix(mlp_clf, x_test, y_test)
